...
\begin{align}
    \frac{C_{ab}^x}{\Lambda} = \frac{i\lambda_a^\prime\lambda_b^{\prime*}}{128\pi^2M_S}\sum_{i,j}i\left[g_{aS}^{ij}g_{bPS}^{ij*} - g_{aPS}^{ij}g_{bS}^{ij*}\right]\frac{F_{\Pi_x}}{M_S}\lambda_{ij}^x,
\end{align}
