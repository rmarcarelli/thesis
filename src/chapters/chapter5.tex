...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/chapter5/Cah_CMS_constraint.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/chapter5/Ctl_vs_ma_limits_Cahp=0.pdf}
    \includegraphics[width=\linewidth]{figures/chapter5/Ctl_vs_ma_limits_Cah=0.pdf}
